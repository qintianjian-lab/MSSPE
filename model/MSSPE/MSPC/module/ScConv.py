...
# @file ScConv.py
# @author: wujiangu
# @date: 2023-12-23 18:29
# @description: ScConv module
...
class ScConv_2D(nn.Module):
    def __init__(
        ...
        group_size: int = 2,
        group_kernel_size: int = 3,
        scconv_sr: bool = False,
        scconv_cr: bool = False,
    ):
        super().__init__()

        self.scconv_sr = scconv_sr
        self.scconv_cr = scconv_cr
